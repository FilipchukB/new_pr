...
class Info:
    def __init__(self, screen, settings):
        ...
        self.screen = screen
        self.fon = pygame.image.load('fon.jpg').convert_alpha()
    ...
    def info_ansver(self):
        ...
        if self.settings.current_level == 11:
            if self.settings.histori_1 == 0:  # L1
                self.screen.blit(self.c_not, (100, 100))
                if 100 < mouse[0] < 300 and 100 < mouse[1] < 300:
                    self.screen.blit(self.pl1, (0, 0))
                    print('o0p')
            if self.settings.histori_2 == 0:  # L2
                self.screen.blit(self.c_not, (300, 100))
            if self.settings.histori_3 == 0:  # L3
                self.screen.blit(self.c_not, (500, 100))
            if self.settings.histori_4 == 0:  # L4
                self.screen.blit(self.c_not, (700, 100))
            if self.settings.histori_5 == 0:  # L5
                self.screen.blit(self.c_not, (900, 100))
            if self.settings.histori_6 == 0:  # L6
                self.screen.blit(self.c_not, (100, 500))
            if self.settings.histori_7 == 0:  # L7
                self.screen.blit(self.c_not, (300, 500))
            if self.settings.histori_8 == 0:  # L8
                self.screen.blit(self.c_not, (500, 500))
            if self.settings.histori_9 == 0:  # L9
                self.screen.blit(self.c_not, (700, 500))
            if self.settings.histori_10 == 0:  # L10
                self.screen.blit(self.c_not, (900, 500))
